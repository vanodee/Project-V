...
export const front_end_projects_loader = async () => {
  const res = await fetch('https://project-v-git-verceldeploy-vanodees-projects.vercel.app/front_end_projects');
  return res.json();
}

export const ux_case_studies_loader = async () => {
  const res = await fetch('https://project-v-git-verceldeploy-vanodees-projects.vercel.app/ux_case_studies');
  return res.json();
}

export const ui_designs_loader = async () => {
  const res = await fetch('https://project-v-git-verceldeploy-vanodees-projects.vercel.app/ui_designs');
  return res.json();
}

export const logo_designs_loader = async () => {
  const res = await fetch('https://project-v-git-verceldeploy-vanodees-projects.vercel.app/logo_designs');
  return res.json();
}

export const brand_designs_loader = async () => {
  const res = await fetch('https://project-v-git-verceldeploy-vanodees-projects.vercel.app/brand_designs');
  return res.json();
}